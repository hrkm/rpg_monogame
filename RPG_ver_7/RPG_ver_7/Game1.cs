...
namespace RPG_ver_7
{
    ...
    public class Game1 : Game
    {
        ...
        /// <summary>
        /// Docelowa szarokoϾ ekranu.
        /// </summary>
        private const int Width = 480;
        /// <summary>
        /// Docelowa wysokoϾ ekranu.
        /// </summary>
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            mouse.Position = renderer.ScaleMouseToScreenCoordinates(new Vector2(mouseState.X, mouseState.Y));
            ...
            if (!GameOver)
            {
                ...
                foreach (TouchLocation tl in touchCollection)
                {
                    if (tl.State == TouchLocationState.Pressed || tl.State == TouchLocationState.Moved)
                    {
                        ...
                        touchLocation.Position = renderer.ScaleMouseToScreenCoordinates(tl.Position);
                        foreach (var singleLine in lines)
                        {
